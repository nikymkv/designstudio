    ...
    <div class="col">
        <div class="card">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link {{ $enTab == 0 ? 'active' : 'disabled' }}" href="{{ route('backend.employees.show', ['employee' => $employee]) }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $enTab == 1 ? 'active' : 'disabled' }}" href="{{ route('backend.employees.show', ['employee' => $employee]) }}"
                        onclick="event.preventDefault();
